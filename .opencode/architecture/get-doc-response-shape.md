---
type: decision
title: "get_doc Response Shape: Inline Content vs. File-Path Only"
description: Evaluates whether get_doc should return full content inline, file-path only, or an intermediate option — with a recommended incremental improvement.
tags: [mcp, api, design, token-cost, response-shape]
---
